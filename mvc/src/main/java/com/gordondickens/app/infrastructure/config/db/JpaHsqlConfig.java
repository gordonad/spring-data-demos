 ...
 * Date: 2012-11-20
 * <p/>
 * Derby Spring Configuration - assumes Derby DB is already running
 * <p/>
 ...
 */
@Configuration
public class JpaHsqlConfig extends JpaPersistenceCommonConfig {
...
//        populator.addScript(new ClassPathResource("/sql/demo.sql"));
        try {
