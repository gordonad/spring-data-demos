 ...
 * @see org.springframework.context.annotation.Profile - Component is eligible for registration when one or more specified profiles are active
 */
@Configuration
@Profile(DatabaseConfigProfile.H2_EMBEDDED)
@PropertySource("classpath:/META-INF/spring/h2database.properties")
public class JpaH2EmbeddedConfig extends JpaCommonConfig {
