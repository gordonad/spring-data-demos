 ...
 * @see org.springframework.context.annotation.Profile - Component is eligible for registration when one or more
...
@Configuration
@PropertySource("classpath:/META-INF/spring/postgresql.properties")
public class JpaPostgresqlConfig extends JpaCommonConfig {
