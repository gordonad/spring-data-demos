...
@ActiveProfiles(DatabaseConfigProfile.H2_EMBEDDED)

@Transactional
@ContextConfiguration(classes = {JpaH2EmbeddedConfig.class, TestConfig.class})
@RunWith(SpringJUnit4ClassRunner.class)
public class EmployeeH2IntegrationTest {
    private static final Logger logger = LoggerFactory
            .getLogger(EmployeeH2IntegrationTest.class);
